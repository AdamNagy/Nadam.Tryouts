...
class SidePagerElement extends HTMLElement {
  ...
  createPageSkeleton() {
    var pageElement = this.domParser
      .parseFromString(this.template, "text/html")
      .querySelector("div:first-child");

    pageElement.style.zIndex = 11 + this.nextPageId;

    pageElement.querySelector("div[class='side-page-opener']").addEventListener(
      "click",
      ((pageId) => () => {
