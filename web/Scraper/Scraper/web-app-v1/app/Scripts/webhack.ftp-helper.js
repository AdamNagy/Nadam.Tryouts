...
Nadam.Webhack.FtpHelper = new function () {

    var simpleHandler = (imageLinkHref, thumbnailImageSource) => thumbnailImageSource;

    var imagevenueurlHandler = function (currSrc) {
    ...
    var imagezillaHandler = function (currSrc) {
    ...
    var pixhostHandler = function (currSrc) {
    ...
    var fappicHandler = function (currSrc) {
    ...
    var imagetwistHandler = function (thumbnailImageSource) {
    ...
    var acidimgHandler = function (currSrc) {
    ...
    var imagebamHandler = function (currSrc) {
    ...
    var imgboxHandler = function (currSrc) {
    ...
    var imxHandler = function (currSrc) {
    ...
    var getFtpName = function (source) {
    ...
    this.GetFtpHandler = function (imageMetas) {
        ...
        switch (ftp) {
            case "imagevenue":
                ...
                break;
            case "acidimg":
                meta = { "ftpHandler": acidimgHandler, "type": "image" };
                break;
            case "img.yt":
            case "sexyimg":
            case "imx":
            case "imgserve":
                meta = { "ftpHandler": imxHandler, "type": "image" };
                break;
            case "imagezilla":
                meta = { "ftpHandler": imagezillaHandler, "type": "image" };
                break;
            case "imagetwist":
                meta = { "ftpHandler": imagetwistHandler, "type": "image" };
                break;
            case "imgdino":
                meta = { "ftpHandler": imgdinoHandler, "type": "image" };
                break;
            case "imgchili":
                meta = { "ftpHandler": imgchiliHandler, "type": "image" };
                break;
            case "pixhost":
                meta = { "ftpHandler": pixhostHandler, "type": "image" };
                break;
            case "fappic":
                meta = { "ftpHandler": fappicHandler, "type": "image" };
                break;
            case "imgbox":
                meta = { "ftpHandler": imgboxHandler, "type": "image" };
                break;
