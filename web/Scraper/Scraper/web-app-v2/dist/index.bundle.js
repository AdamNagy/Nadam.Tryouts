...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"GalleryComponent\", function() { return GalleryComponent; });\n/* harmony import */ var _webhack_ftp_helper_lib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./webhack.ftp-helper.lib */ \"./src/app/webhack.ftp-helper.lib.js\");\n/* harmony import */ var _nadam_nadam_removable_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../nadam/nadam.removable.element */ \"./src/nadam/nadam.removable.element.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar GalleryComponent =\n/*#__PURE__*/\nfunction () {\n  function GalleryComponent(_galleryModel) {\n    var _this = this;\n\n    _classCallCheck(this, GalleryComponent);\n\n    this.model = _galleryModel;\n    this.item = document.createElement(\"div\");\n    this.item.classList.add(\"grid\");\n    this.images = new Array(); //this.item.classList.add(\"d-flex\");\n    //this.item.classList.add(\"justify-content-center\");\n    //this.item.classList.add(\"flex-wrap\");\n\n    for (var i = 0; i < this.model.ImagesMetaData.length; ++i) {\n      var newImg = new Image(); // document.createElement(\"img\");\n      //newImg.name = this.model.ImagesMetaData[i].ThumbnailImageSrc;\n      //newImg.setAttribute(\"src\", this.model.ImagesMetaData[i].ThumbnailImageSrc);\n\n      newImg.setAttribute(\"data-image-link-href\", this.model.ImagesMetaData[i].LinkHref); // newImg.classList.add(\"p-1\");\n\n      var removable = new _nadam_nadam_removable_element__WEBPACK_IMPORTED_MODULE_1__[\"RemovableElement\"](newImg);\n      removable.item.classList.add(\"grid-item\");\n\n      newImg.onload = function (_imgContainer) {\n        return function () {\n          if (this.height > this.width) _imgContainer.classList.add(\"grid-item--portrait\");else _imgContainer.classList.add(\"grid-item--landscape\");\n        };\n      }(removable.item);\n\n      newImg.src = this.model.ImagesMetaData[i].ThumbnailImageSrc;\n      this.images.push(newImg);\n      this.item.append(removable.item);\n    }\n\n    this.hacker = _webhack_ftp_helper_lib__WEBPACK_IMPORTED_MODULE_0__[\"FtpHelper\"].GetFtpHandler(this.model.ImagesMetaData);\n\n    if (this.hacker.ftpHandler !== undefined) {\n      var hackPromise = this.HackImages(this.model.ImagesMetaData, this.hacker);\n      hackPromise.then(function () {\n        for (var i = 0; i < 10; i++) {\n          console.log(_this.model.ImagesMetaData[i].RealImageSrc);\n        }\n      });\n    }\n  }\n\n  _createClass(GalleryComponent, [{\n    key: \"HackImages\",\n    value: function () {\n      var _HackImages = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee(imagesMetaData, hacker) {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                return _context.abrupt(\"return\", new Promise(function (resolve, reject) {\n                  for (var i = 0; i < imagesMetaData.length; i++) {\n                    imagesMetaData[i].RealImageSrc = hacker.ftpHandler(imagesMetaData[i].ThumbnailImageSrc);\n                  }\n\n                  resolve();\n                }));\n\n              case 1:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      function HackImages(_x, _x2) {\n        return _HackImages.apply(this, arguments);\n      }\n\n      return HackImages;\n    }()\n  }]);\n\n  return GalleryComponent;\n}();\n\n//# sourceURL=webpack:///./src/app/webhack.gallery.component.js?");

/***/ }),

/***/ "./src/app/webhack.galley.model.js":
/*!*****************************************!*\
  !*** ./src/app/webhack.galley.model.js ***!
  \*****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Http\", function() { return Http; });\n/* harmony import */ var timers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! timers */ \"./node_modules/timers-browserify/main.js\");\n/* harmony import */ var timers__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(timers__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nfunction Sleep(ms) {\n  return new Promise(function (resolve) {\n    return Object(timers__WEBPACK_IMPORTED_MODULE_0__[\"setTimeout\"])(resolve, ms);\n  });\n}\n\nvar Http =\n/*#__PURE__*/\nfunction () {\n  _createClass(Http, null, [{\n    key: \"Get\",\n    value: function () {\n      var _Get = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee(url) {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                return _context.abrupt(\"return\", new Promise(function (resolve, reject) {\n                  if (url === undefined) reject(\"Url is null\");\n                  var request = new XMLHttpRequest();\n                  request.timeout = 10000;\n                  /**\r\n                   * xmlhttp.readyState enum:\r\n                   * 0\tUNSENT\tClient has been created. open() not called yet.\r\n                   * 1\tOPENED\topen() has been called.\r\n                   * 2\tHEADERS_RECEIVED\tsend() has been called, and headers and status are available.\r\n                   * 3\tLOADING\tDownloading; responseText holds partial data.\r\n                   * 4\tDONE\tThe operation is complete.\r\n                   */\n\n                  request.onreadystatechange = function () {\n                    if (request.readyState === 4 && request.status === 200) {\n                      resolve(request.responseText);\n                    } else if (request.readyState === 4 && request.status === 0) {\n                      reject({\n                        readyState: request.readyState,\n                        status: request.status\n                      });\n                    } else if (request.readyState === 4 && request.status !== 200) {\n                      reject({\n                        readyState: request.readyState,\n                        status: request.status\n                      });\n                    }\n                  };\n\n                  try {\n                    request.open(\"GET\", url);\n                    request.send();\n                  } catch (_unused) {\n                    reject({\n                      readyState: request.readyState,\n                      status: request.status\n                    });\n                  }\n                }));\n\n              case 1:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      function Get(_x) {\n        return _Get.apply(this, arguments);\n      }\n\n      return Get;\n    }()\n  }]);\n\n  function Http() {\n    _classCallCheck(this, Http);\n\n    this.queueState = this.initState();\n  }\n\n  _createClass(Http, [{\n    key: \"queueItemReduxer\",\n    value: function queueItemReduxer(squenceNum, handler) {\n      var _this = this;\n\n      return function (result) {\n        for (var i = 0; i < _this.queueState.queue.length; ++i) {\n          if (_this.queueState.queue[i] !== undefined && _this.queueState.queue[i].squenceNum === squenceNum) {\n            _this.queueState.queue.splice(_this.queueState.queue[i], 1);\n\n            --_this.queueState.inTheQueue;\n          }\n        }\n\n        if (handler !== undefined) {\n          _this.queueState.numOfSuccess = _this.queueState.numOfSuccess + 1;\n          handler(result);\n        }\n      };\n    }\n  }, {\n    key: \"initState\",\n    value: function initState() {\n      return {\n        queue: new Array(),\n        urls: new Array(),\n        failedUrls: new Array(),\n        nextItemIdx: 0,\n        inTheQueue: 0,\n        numOfSuccess: 0\n      };\n    }\n  }, {\n    key: \"QueuedGet\",\n    value: function () {\n      var _QueuedGet = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee3(urls, numerOfThreds, handler) {\n        var _this2 = this;\n\n        return regeneratorRuntime.wrap(function _callee3$(_context3) {\n          while (1) {\n            switch (_context3.prev = _context3.next) {\n              case 0:\n                this.queueState = this.initState();\n                return _context3.abrupt(\"return\", new Promise(\n                /*#__PURE__*/\n                function () {\n                  var _ref = _asyncToGenerator(\n                  /*#__PURE__*/\n                  regeneratorRuntime.mark(function _callee2(resolve, reject) {\n                    var queueItem, attempts, _queueItem;\n\n                    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                      while (1) {\n                        switch (_context2.prev = _context2.next) {\n                          case 0:\n                            if (numerOfThreds === undefined) numerOfThreds = 3;\n                            _this2.queueState.urls = urls;\n\n                            for (; _this2.queueState.nextItemIdx < numerOfThreds;) {\n                              queueItem = {\n                                promise: Http.Get(urls[_this2.queueState.nextItemIdx]),\n                                squenceNum: _this2.queueState.nextItemIdx,\n                                url: urls[_this2.queueState.nextItemIdx]\n                              };\n                              ++_this2.queueState.nextItemIdx;\n                              queueItem.promise.then(_this2.queueItemReduxer(queueItem.squenceNum, handler), _this2.queueItemReduxer(queueItem.squenceNum));\n\n                              _this2.queueState.queue.push(queueItem);\n\n                              ++_this2.queueState.inTheQueue;\n                            }\n\n                            attempts = 0;\n\n                          case 4:\n                            if (!(_this2.queueState.nextItemIdx < urls.length || _this2.queueState.inTheQueue > 0)) {\n                              _context2.next = 21;\n                              break;\n                            }\n\n                            ++attempts;\n\n                            if (!(_this2.queueState.inTheQueue < numerOfThreds && _this2.queueState.nextItemIdx < urls.length)) {\n                              _context2.next = 15;\n                              break;\n                            }\n\n                            _queueItem = {\n                              promise: Http.Get(urls[_this2.queueState.nextItemIdx]),\n                              squenceNum: _this2.queueState.nextItemIdx,\n                              url: urls[_this2.queueState.nextItemIdx]\n                            };\n                            ++_this2.queueState.nextItemIdx;\n\n                            _queueItem.promise.then(_this2.queueItemReduxer(_queueItem.squenceNum, handler), _this2.queueItemReduxer(_queueItem.squenceNum));\n\n                            _this2.queueState.queue.push(_queueItem);\n\n                            ++_this2.queueState.inTheQueue;\n                            --attempts;\n                            _context2.next = 17;\n                            break;\n\n                          case 15:\n                            _context2.next = 17;\n                            return Sleep(600);\n\n                          case 17:\n                            if (!(attempts >= 10)) {\n                              _context2.next = 19;\n                              break;\n                            }\n\n                            return _context2.abrupt(\"break\", 21);\n\n                          case 19:\n                            _context2.next = 4;\n                            break;\n\n                          case 21:\n                            if (_this2.queueState.numOfSuccess === _this2.queueState.urls.length) resolve(_this2.queueState.numOfSuccess + \" out of: \" + urls.length + \" was done\");\n                            reject({\n                              failed: _this2.queueState.failedUrls,\n                              message: _this2.queueState.numOfSuccess + \" out of: \" + urls.length + \" was done\"\n                            });\n\n                          case 23:\n                          case \"end\":\n                            return _context2.stop();\n                        }\n                      }\n                    }, _callee2);\n                  }));\n\n                  return function (_x5, _x6) {\n                    return _ref.apply(this, arguments);\n                  };\n                }()));\n\n              case 2:\n              case \"end\":\n                return _context3.stop();\n            }\n          }\n        }, _callee3, this);\n      }));\n\n      function QueuedGet(_x2, _x3, _x4) {\n        return _QueuedGet.apply(this, arguments);\n      }\n\n      return QueuedGet;\n    }()\n  }]);\n\n  return Http;\n}();\n\n//# sourceURL=webpack:///./src/nadam/nadam.http.lib.js?");

/***/ }),

/***/ "./src/nadam/nadam.removable.element.js":
/*!**********************************************!*\
  !*** ./src/nadam/nadam.removable.element.js ***!
  \**********************************************/
/*! exports provided: RemovableElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemovableElement\", function() { return RemovableElement; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar RemovableElement = function RemovableElement(_element) {\n  var _this = this;\n\n  _classCallCheck(this, RemovableElement);\n\n  this.element = _element;\n  this.item = document.createElement(\"div\");\n  this.item.append(_element);\n  this.item.style.position = \"relative\";\n  this.item.style.display = _element.style.display;\n  var remover = document.createElement(\"div\");\n  remover.style.position = \"absolute\";\n  remover.style.right = \"10px\";\n  remover.style.top = \"10px\";\n  remover.style.fontSize = \"20px\";\n  remover.style.cursor = \"pointer\";\n  remover.innerText = \"X\";\n  remover.addEventListener(\"click\", function () {\n    _this.item.remove();\n  });\n  this.element.append(remover);\n};\n;\n\n//# sourceURL=webpack:///./src/nadam/nadam.removable.element.js?");

/***/ }),

/***/ "./src/nadam/nadam.side-pager.control.js":
/*!***********************************************!*\
  !*** ./src/nadam/nadam.side-pager.control.js ***!
  \***********************************************/
/*! exports provided: SidePager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SidePager\", function() { return SidePager; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n// v.1.0.1\n/// usage:\n/// var pageManager = new SidePager();\n///\tpageManager.CreatePage(document.createElement(\"div\").innerText = \"Hello world\");\nvar SidePager =\n/*#__PURE__*/\nfunction () {\n  function SidePager() {\n    _classCallCheck(this, SidePager);\n\n    this.pageManager = document.createElement('div');\n    this.pageManager.style.position = 'fixed';\n    this.pageManager.id = \"side-pages-manager\";\n    document.body.append(this.pageManager);\n    this.pages = new Array();\n    this.domParser = new DOMParser();\n    this.openPages = 0;\n    this.pageWidth = 720;\n    this.spaceBetweenPages = 50;\n    this.template = \"<div class=\\\"side-page\\\">\\n\\t\\t\\t\\t<h3>#title#</h3> \\n\\t\\t\\t\\t<button data-local-id='close-btn'>Close</button>\\n\\t\\t\\t\\t<button data-local-id='remove-btn'>Remove</button>\\n\\t\\t\\t\\t<div class=\\\"side-page-opener\\\"></div>\\n\\t\\t\\t\\t<div class=\\\"side-page-content\\\"></div>\\n\\t\\t\\t</div>\";\n  }\n\n  _createClass(SidePager, [{\n    key: \"createPage\",\n    value: function createPage(title) {\n      var _this = this;\n\n      if (title === undefined) title = \"\";\n      var instanceTemplate = this.template.replace(\"#title#\", title);\n      var pageElement = this.domParser.parseFromString(instanceTemplate, \"text/html\").querySelector(\"div:first-child\");\n      pageElement.style.zIndex = 11 + this.pages.length;\n      pageElement.querySelector(\"div[class='side-page-opener']\").addEventListener(\"click\", function (idx) {\n        return function () {\n          _this.openPage(idx);\n        };\n      }(this.pages.length));\n      pageElement.querySelector(\"button[data-local-id='close-btn']\").addEventListener(\"click\", function (idx) {\n        return function () {\n          _this.closePage(idx);\n        };\n      }(this.pages.length));\n      pageElement.querySelector(\"button[data-local-id='remove-btn']\").addEventListener(\"click\", function (idx) {\n        return function () {\n          _this.RemovePage(idx);\n        };\n      }(this.pages.length));\n      this.pages.push({\n        id: this.pages.length,\n        element: pageElement\n      });\n      this.pageManager.append(pageElement);\n      this.CloseAll();\n    }\n  }, {\n    key: \"openPage\",\n    value: function openPage(pageId) {\n      var index = this.getIndex(pageId);\n      var closedPagesWidth = (this.pages.length - 1 - index) * this.spaceBetweenPages;\n      var openPages_buffer = index * this.spaceBetweenPages;\n      var pageRightPosition = closedPagesWidth + openPages_buffer;\n\n      for (var i = 0; i <= index; ++i) {\n        var currentElement = this.pages[i];\n        currentElement.element.style.right = pageRightPosition + \"px\";\n        currentElement.element.classList.add(\"side-page-open\");\n        currentElement.element.classList.remove(\"side-page-closed\");\n        pageRightPosition -= 50;\n      }\n\n      document.body.style.overflowY = \"hidden\";\n      this.openPages++;\n    }\n  }, {\n    key: \"closePage\",\n    value: function closePage(pageId) {\n      var index = this.getIndex(pageId);\n      var buffer = this.pages.length - index - 1;\n      var pageRightPosition = buffer * 50 + 50;\n\n      for (var i = index; i < this.pages.length; ++i) {\n        var actual = this.pages[i];\n        actual.element.style.left = null;\n        actual.element.style.width = this.pageWidth + \"px\";\n        actual.element.style.right = \"-\" + (720 - pageRightPosition) + \"px\";\n        actual.element.classList.remove(\"side-page-open\");\n        actual.element.classList.add(\"side-page-closed\");\n        pageRightPosition -= 50;\n      }\n\n      this.openPages--;\n\n      if (this.openPages <= 0) {\n        document.body.style.overflowY = \"auto\";\n        this.openPages = 0;\n      }\n    }\n  }, {\n    key: \"getIndex\",\n    value: function getIndex(pageId) {\n      var actual = this.pages.find(function (item) {\n        return item.id === pageId;\n      });\n      var index = this.pages.indexOf(actual);\n      return index;\n    }\n  }, {\n    key: \"RemovePage\",\n    value: function RemovePage(pageId) {\n      var index = this.getIndex(pageId);\n      var toRemove = this.pages[index];\n      this.pages.splice(index, 1);\n      toRemove.element.remove();\n      --this.openPages;\n      if (index > 0) this.openPage(--index);\n    }\n  }, {\n    key: \"CloseAll\",\n    value: function CloseAll() {\n      this.closePage(0);\n      document.body.style.overflowY = \"auto\";\n      this.openPages = 0;\n    }\n  }, {\n    key: \"CreatePage\",\n    value: function CreatePage(rootElement) {\n      this.createPage();\n      var addedPage = this.pages[this.pages.length - 1].element;\n      $(addedPage).resizable({\n        handles: 'w'\n      });\n      addedPage.querySelector(\"div[class=side-page-content]\").append(rootElement);\n    }\n  }]);\n\n  return SidePager;\n}();\n\n//# sourceURL=webpack:///./src/nadam/nadam.side-pager.control.js?");
