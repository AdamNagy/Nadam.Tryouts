...
HTMLElement.prototype.WithCss = function(cssObj: any) {
	for (const propName in cssObj) {
		(this.style as any)[propName] = cssObj[propName];
	}
	return this;
};
...
HTMLElement.prototype.WithoutEventListener = function(eventName: string, event: any) {
...
// other
HTMLElement.prototype.ToParent = function(parent: HTMLElement) {
	parent.append(this);
	return this;
};
