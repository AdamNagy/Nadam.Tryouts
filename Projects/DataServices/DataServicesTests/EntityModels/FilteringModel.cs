...
{
    public class FilteringModel : IComparable<FilteringModel>
    {
        ...
        public int CompareTo(FilteringModel? other)
        {
        ...
        public static IEnumerable<FilteringModel> GenerateData()
             => Enumerable.Range(0, 100).Select(p => new FilteringModel()
             {
                 GreaterThanSome = p,
                 GreaterThanAll = p + 51,
