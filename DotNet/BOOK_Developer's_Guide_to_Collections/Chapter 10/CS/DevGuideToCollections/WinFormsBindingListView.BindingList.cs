...
{
    public partial class WinFormsBindingListView<T> : IBindingList, ICancelAddNew 
    {
        public event ListChangedEventHandler ListChanged;

        List<ListSortDescription> m_sortDescriptors;
        bool m_isSorted;
        ...
        {
            m_sortDescriptors = new List<ListSortDescription>();
        ...
        void T_OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (IsSorted)
            {
                ...
                foreach (var sd in m_sortDescriptors)
                {
                    if (sd.PropertyDescriptor.Name == e.PropertyName)
                    {
                        shouldSort = true;
                        break;
                    }
