...
{
    public partial class WinFormsBindingListView<T>
    {
        List<T> m_data;
        ...
        /// </summary>
        public WinFormsBindingListView()
        {
            m_data = new List<T>();
        ...
        /// </summary>
        /// <param name="items">Adds items to the WinFormsBindingListView(T).</param>
        public WinFormsBindingListView(IEnumerable<T> items)
        {
            m_data = new List<T>();
            InitializeBindingSupport();
        ...
        public WinFormsBindingListView(int capacity)
        {
