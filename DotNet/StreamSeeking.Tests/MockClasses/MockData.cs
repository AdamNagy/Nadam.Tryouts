...
namespace StreamSeeking.Tests.MockClasses
{
    ...
    {
        //public static string[] MOCK_TEXT = new []
        //    {
        ...
        public static string[] MOCK_TEXT = new[]
    {
        ...
        public static int[] MOCK_NUMBERS = new[]
        {
            1492, 1989, 2012, 2020, 1
        };

        public static IEnumerable<string> MOCK_STRING_ARRAY1 = MOCK_TEXT[0].Split(' ');
        public static IEnumerable<string> MOCK_STRING_ARRAY2 = MOCK_TEXT[1].Split(' ');
        public static IEnumerable<string> MOCK_STRING_ARRAY3 = MOCK_TEXT[2].Split(' ');
        public static IEnumerable<string> MOCK_STRING_ARRAY4 = MOCK_TEXT[3].Split(' ');
        public static IEnumerable<string> MOCK_STRING_ARRAY5 = MOCK_TEXT[4].Split(' ');

        public static IEnumerable<int> MOCK_NUMBERS_ARRAY1 = GenerateRandoms(5);
        public static IEnumerable<int> MOCK_NUMBERS_ARRAY2 = GenerateRandoms(5);
        public static IEnumerable<int> MOCK_NUMBERS_ARRAY3 = GenerateRandoms(5);
        public static IEnumerable<int> MOCK_NUMBERS_ARRAY4 = GenerateRandoms(5);
        public static IEnumerable<int> MOCK_NUMBERS_ARRAY5 = GenerateRandoms(5);

        public static IEnumerable<ComplexJsonType> MOCK_COMPLEX_ARRAY= new List<ComplexJsonType>(3)
        {
