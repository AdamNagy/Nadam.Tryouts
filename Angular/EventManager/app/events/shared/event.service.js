...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.getEvents = function () {
        return this.http.get('/api/events').map(function (res) {
            return res.json();
        }).catch(this.handleError);
    };
    EventService.prototype.getEvent = function (id) {
        return this.http.get('/api/events/' + id).map(function (res) {
            return res.json();
        }).catch(this.handleError);
    };
    ...
    EventService.prototype.searchSessions = function (searchTerm) {
        ...
        //
        // return emitter;
        return this.http.get('/api/sessions/search?search=' + searchTerm).map(function (res) {
            return res.json();
        }).catch(this.handleError);
    };
    EventService.prototype.handleError = function (err) {
        return RX_1.Observable.throw(err.statusText);
    };
